            ...
            <tr>
              ...
              <tbody>
                    <?php foreach($monitoring_kelahiran as $row) : ?>      
                          <tr>
                            <td><div align="center"><?php print $row->nik; ?></div></td>
                            <td><div align="center"><?php print $row->nm_kpl_keluarga; ?></div></td>
                            <td><div align="center"><?php print $row->nama_ibu; ?></div></td>
                            <td><div align="center"><?php print $row->nm_lengkap; ?></div></td>
                            <td><div align="center"><?php echo date("d M Y H:i:s",strtotime($row->tgl_daftar)); ?></div></td>
                            <td><div align="center"><?php print $row->tgl_ambil; ?></div></td>
                            <td><div align="center"><?php print $row->status; ?></div></td>
                            <td width="20%"><div align="center">
                            <a href="<?php echo base_url()?>index.php/cetak/view_kelahiran/<?php print $row->nik; ?>/<?php print $row->id_berkas; ?>" type="button" class="fa fa-eye"><b> Lihat | </b></a>
                            <a href="<?php echo base_url()?>index.php/cetak/cetak_kelahiran/<?php print $row->nik; ?>/<?php print $row->id_berkas; ?>" type="button" target="_blank" class="fa fa-print"><b> Cetak</b></a></div></td>
                         </tr>
